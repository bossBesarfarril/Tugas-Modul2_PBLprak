...
// ValidateRegister memeriksa kelengkapan dan format data pendaftaran akun.
...
// ValidateLogin hanya memeriksa kelengkapan input, BUKAN kekuatan password.
...
// CheckPasswordStrength memeriksa apakah password memenuhi syarat keamanan.
func CheckPasswordStrength(password string) string {
	...
	// Daftar password terlalu umum / lemah
