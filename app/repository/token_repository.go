...
// FindActive hanya mencari token yang BELUM dicabut (revoked_at IS NULL)
// dan BELUM kedaluwarsa (expires_at > NOW()).
...
// Revoke menandai token sebagai dicabut dengan mengisi revoked_at = NOW()
