...
// main hanya berisi urutan perakitan dan graceful shutdown.
func main() {
	// 1. Konfigurasi dan logger terstruktur
	config.LoadEnv()
	logger := config.NewLogger()

	// 2. Koneksi pool database PostgreSQL
	...
	// 5. Graceful shutdown: tunggu sinyal Ctrl+C / SIGTERM
